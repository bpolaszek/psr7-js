...
describe('URI', () => {
  ...
  it('returns the proper user host', () => {
    ...
    expect(uri('http://www.example.org:8080').getHost()).toBe('www.example.org')
  ...
  it('can use query strings as objects', () => {
    ...
    expect(location.withQuery(qs.withParam('foo', 'baz')).toString()).toBe('http://example.org/?foo=baz')
  })
